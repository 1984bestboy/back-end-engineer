		...
		function showLineChart() {
			...
			$("#chart").shieldChart({
				...
				axisX : {
					...
					ticksRepeat:21 //only every n-th tick will be rendered.
				},
				axisY : {
					axisTickText : {
						format : "{text:c}"
...
<body class="theme-light">
	<form id="formId">
		<p>
			...
			<img id='imgpicchkdat' src="image/calendar.gif" align="middle"/>
                    <script type="text/javascript">
                        Calendar.setup({
			...
			<img id='imgpicchkdat2' src="image/calendar.gif" align="middle"/>
                    <script type="text/javascript">
                        Calendar.setup({
                            inputField: "endDate",
